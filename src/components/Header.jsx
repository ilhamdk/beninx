...
const header = () => {
  ...
  return (
    <header className="fixed z-50 w-screen p-4 px-5 md:p-6 md:px-16 bg-primary ">
      {/* desktop and tablet */}
      <div className="items-center justify-between hidden w-full h-full md:flex">
        ...
        <div className="flex items-center gap-8">
          ...
          >
            <li className="text-base transition-all duration-100 ease-in-out cursor-pointer text-textColor hover:text-headingColor" onClick={()=>setisMenu(false)}>
              Home
            </li>
            <li className="text-base transition-all duration-100 ease-in-out cursor-pointer text-textColor hover:text-headingColor" onClick={()=>setisMenu(false)}>
              Menu
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "barbeninx@gmail.com" && (
                  <Link to={"/createItem"}>
                    <p className="flex items-center gap-3 px-4 py-2 text-base transition-all duration-100 ease-in-out rounded-t-lg cursor-pointer hover:bg-slate-100 text-textcolor" onClick={()=>setisMenu(false)}>
                      <MdAdd /> New Item
                    </p>
                  </Link>
                )}
